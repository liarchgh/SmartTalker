...
public class Test extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mIat = SpeechRecognizer.createRecognizer(Test.this, mInitListener);
		
		// 初始化听写Dialog，如果只使用有UI听写功能，无需创建SpeechRecognizer
		// 使用UI听写功能，请根据sdk文件目录下的notice.txt,放置布局文件和图片资源
		mIatDialog = new RecognizerDialog(Test.this, mInitListener);

		mSharedPreferences = getSharedPreferences(IatSettings.PREFER_NAME,
				Activity.MODE_PRIVATE);
		mToast = Toast.makeText(this, "", Toast.LENGTH_SHORT);
		mResultText = ((EditText) findViewById(R.id.voice_et));
...
//		mIat.setParameter(SpeechConstant.ACCENT, "mandarin ");    
	...
	private void initLayout() {
		SpeechUtility.createUtility(Test.this, SpeechConstant.APPID +"=5a6ac2f1");   
		findViewById(R.id.voice_bt).setOnClickListener(Test.this);
		findViewById(R.id.voice_play).setOnClickListener(Test.this);
...
//			break;
		...
		case R.id.voice_bt:
			// 移动数据分析，收集开始听写事件
			FlowerCollector.onEvent(Test.this, "iat_recognize");
